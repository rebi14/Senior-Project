...
def scan_known_people(known_people_folder):
    ...
    for file in image_files_in_folder(known_people_folder):
       ...
       # click.echo("encoding for {} = {}".format(basename, encodings[0]))
...
@click.option('--image_to_check',default = "classPhotos/")
@click.option('--known_people_folder',default="studentPhotos/")
